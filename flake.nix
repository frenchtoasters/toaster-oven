      ...
      home-manager.lib.homeManagerConfiguration {
        ...
        modules = [
          ({ pkgs, lib, ... }: {
            ...
            home.packages = (commonPackages pkgs) ++ (with pkgs; [
              cacert
              rustup
              nodejs
              pkg-config
            ...
            home.activation.mergeAuthorizedKeys = lib.hm.dag.entryAfter ["writeBoundary"] ''
              ...
              # If we find a real file (not symlink) at target, and no backup exists, move it to backup.
              ...
              # Append Backup keys if they exist
